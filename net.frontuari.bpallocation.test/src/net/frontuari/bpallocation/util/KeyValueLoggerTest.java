...
import static net.frontuari.bpallocation.test.util.RandomTestUtil.*;
import static net.frontuari.bpallocation.test.util.ReflectionTestUtil.*;
...
class KeyValueLoggerTest {
	...
	void shouldPrintClassFromClass() {
		...
		verifyStringLog(Level.INFO, "class=\"net.frontuari.bpallocation.util.KeyValueLogger\"");
	}
	...
	void shouldPrintPackageFromClass() {
		...
		verifyStringLog(Level.INFO, "package=\"net.frontuari.bpallocation.util\"");
	}
